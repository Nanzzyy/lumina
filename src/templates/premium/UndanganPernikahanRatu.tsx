...
export function UndanganPernikahanRatu({ content, slug, preview }: MonolithicTemplateProps) {
  ...
  return (
    <div className="font-body min-h-screen relative overflow-x-hidden" style={{ backgroundColor: IVORY, color: BLACK }}>
      ...
      {/* Lightbox */}
      {lightboxIndex !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: `${BLACK}F0`, backdropFilter: 'blur(6px)' }} onClick={() => setLightboxIndex(null)} data-lumina-lightbox>
