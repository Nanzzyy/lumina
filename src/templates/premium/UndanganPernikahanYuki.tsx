...
export function UndanganPernikahanYuki({ content, slug, preview }: MonolithicTemplateProps) {
        ...
        <motion.div className="relative z-20 px-6 max-w-md w-full text-center"
          ...
          <motion.div variants={stagI} className="mt-9">
            <button onClick={open}
              ...
              <span className="relative z-10 flex items-center gap-2.5">Buka Undangan</span>
  ...
  return (
    <div className="font-body min-h-screen relative overflow-x-hidden" style={{ backgroundColor: ICE, color: SLATE }}>
      ...
      {/* Lightbox */}
      {lightboxIndex !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: `${SLATE}F2`, backdropFilter: 'blur(6px)' }} onClick={() => setLightboxIndex(null)} data-lumina-lightbox>
